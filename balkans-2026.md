...
and treating [Brela](https://en.wikipedia.org/wiki/Brela)/
[Baska Voda](https://en.wikipedia.org/wiki/Ba%C5%A1ka_Voda) as a coastal stop
instead of an overnight. [[1]](#source-1)[[2]](#source-2)

## Rick Steves Lens

- Prioritize the big-impact stops:
  [Dubrovnik](https://en.wikipedia.org/wiki/Dubrovnik),
  [Mostar](https://en.wikipedia.org/wiki/Mostar),
  [Split](https://en.wikipedia.org/wiki/Split,_Croatia), and
  [Plitvice](https://en.wikipedia.org/wiki/Plitvice_Lakes_National_Park).
  [[1]](#source-1)[[2]](#source-2)[[3]](#source-3)
- Use the car where it helps most:
  [Bosnia and Herzegovina](https://en.wikipedia.org/wiki/Bosnia_and_Herzegovina),
  [Peljesac](https://en.wikipedia.org/wiki/Pelje%C5%A1ac)/[Ston](https://en.wikipedia.org/wiki/Ston),
  [Plitvice](https://en.wikipedia.org/wiki/Plitvice_Lakes_National_Park), and
  the final [Slovenia](https://en.wikipedia.org/wiki/Slovenia) /
  [Italy](https://en.wikipedia.org/wiki/Italy) approach.
  [[1]](#source-1)[[4]](#source-4)
- Keep old-town time unrushed: early mornings and evenings matter more than
  adding extra checklist stops. [[1]](#source-1)
- Treat [Plitvice](https://en.wikipedia.org/wiki/Plitvice_Lakes_National_Park)
  as the major inland nature detour. In this compressed version, this means
  skipping
  [Opatija](https://en.wikipedia.org/wiki/Opatija),
  [Piran](https://en.wikipedia.org/wiki/Piran),
  [Postojna Cave](https://en.wikipedia.org/wiki/Postojna_Cave), and
  [Skocjan Caves](https://en.wikipedia.org/wiki/%C5%A0kocjan_Caves).
  [[3]](#source-3)[[5]](#source-5)
- Skip [Hvar](https://en.wikipedia.org/wiki/Hvar) /
  [Korcula](https://en.wikipedia.org/wiki/Kor%C4%8Dula),
  [Krka](https://en.wikipedia.org/wiki/Krka_National_Park),
  [Sibenik](https://en.wikipedia.org/wiki/%C5%A0ibenik), and
  [Istrian hill towns](https://en.wikipedia.org/wiki/Istria). [[1]](#source-1)
...
- Start with [Illyria](https://en.wikipedia.org/wiki/Illyria), not modern
  borders. Before Croats, Bosnians, Slovenes, Venetians, Ottomans, Habsburgs,
  or Yugoslavia, the Adriatic coast and inland mountains were associated with
  Illyrian peoples; Rome later organized the region through
...
- [Split](https://en.wikipedia.org/wiki/Split,_Croatia) is the Roman layer
  made physical: [Diocletian's Palace](https://en.wikipedia.org/wiki/Diocletian%27s_Palace)
  turns the old imperial Adriatic into the city center instead of a museum.
  [[48]](#source-48)[[49]](#source-49)
- [Dubrovnik](https://en.wikipedia.org/wiki/Dubrovnik), historically
  [Ragusa](https://en.wikipedia.org/wiki/Republic_of_Ragusa), was not just
  another Dalmatian town. It was a small maritime republic that balanced trade,
  diplomacy, tribute, and fortifications between larger powers. [[50]](#source-50)
...
- The word "Illyrian" comes back later in a very different way: Napoleon's
  ...
  Ragusa/Dubrovnik into a French imperial unit from 1809 to 1813. [[53]](#source-53)
- The 20th-century layer is [Yugoslavia](https://en.wikipedia.org/wiki/Yugoslavia):
  Croatia, Slovenia, and Bosnia and Herzegovina were later tied into South Slav
  states, then became independent during the breakup of Yugoslavia. The practical
  travel takeaway is simple: old-town beauty and recent history sit close
  together here, especially in Bosnia and Herzegovina. [[54]](#source-54)
...
- Start with the [Walls of Dubrovnik](https://en.wikipedia.org/wiki/Walls_of_Dubrovnik) first thing in the morning or late afternoon; this is the signature Dubrovnik sight and the most crowd-sensitive part of the day. [[11]](#source-11)[[42]](#source-42)[[43]](#source-43)
- Use [Stradun](https://en.wikipedia.org/wiki/Stradun_%28street%29) as the spine of the old-town walk: Pile Gate ([map](https://www.google.com/maps/search/?api=1&query=Pile%20Gate%2C%20Dubrovnik%2C%20Croatia)), Onofrio's Fountain ([map](https://www.google.com/maps/search/?api=1&query=Onofrio%27s%20Fountain%2C%20Dubrovnik%2C%20Croatia)), the Franciscan Monastery ([map](https://www.google.com/maps/search/?api=1&query=Franciscan%20Monastery%2C%20Dubrovnik%2C%20Croatia)), [Sponza Palace](https://en.wikipedia.org/wiki/Sponza_Palace), and [Rector's Palace](https://en.wikipedia.org/wiki/Rector%27s_Palace,_Dubrovnik). [[42]](#source-42)
- For a viewpoint, take the cable car to [Srđ](https://en.wikipedia.org/wiki/Sr%C4%91) near sunset if the weather is clear and winds are calm; check the official timetable before banking on it. [[42]](#source-42)[[44]](#source-44)
- If you arrive early and want nature more than museums, swap the afternoon palace/museum time for [Lokrum](https://en.wikipedia.org/wiki/Lokrum). Treat it as a half-day island escape, and verify the current boat schedule because operations are seasonal and weather-dependent. [[45]](#source-45)
...
Best stops:
- [Walls of Dubrovnik](https://en.wikipedia.org/wiki/Walls_of_Dubrovnik), especially early or late for softer light and fewer groups. [[11]](#source-11)[[43]](#source-43)
- [Stradun](https://en.wikipedia.org/wiki/Stradun_%28street%29), side lanes, and harbor edges for the low-effort old-town wander. [[42]](#source-42)
- [Srđ](https://en.wikipedia.org/wiki/Sr%C4%91) for the city-and-islands view, or [Lokrum](https://en.wikipedia.org/wiki/Lokrum) if you want swimming, shade, and a break from stone lanes. [[42]](#source-42)[[44]](#source-44)[[45]](#source-45)
...
- Use [Postojna](https://en.wikipedia.org/wiki/Postojna), Vipava
  ...
  Gorizia ([map](https://www.google.com/maps/search/?api=1&query=Gorizia%2C%20Italy)),
  or Palmanova ([map](https://www.google.com/maps/search/?api=1&query=Palmanova%2C%20Italy))
  only as fuel/coffee/driver-change stops, not sightseeing stops.
...
Food notes:
- Assume dinner with Mirco or a local plan after arrival. If you need a backup, keep it local around [Montevecchia](https://en.wikipedia.org/wiki/Montevecchia) / Merate ([map](https://www.google.com/maps/search/?api=1&query=Merate%2C%20Italy)) rather than detouring into Milan or Como at the end of the drive.

Lodging notes:
- Sleep at Mirco's. Confirm the arrival window, parking, and whether you should return the rental car before or after the visit.
...
8. <a id="source-8"></a>[EU temporary internal border controls list](https://home-affairs.ec.europa.eu/policies/schengen-borders-and-visa/schengen-area/temporary-reintroduction-border-control_en)
...
20. <a id="source-20"></a>[Time Out: Kopun, Dubrovnik](https://www.timeout.com/croatia/restaurants/kopun)
21. <a id="source-21"></a>[Gault&Millau: Kapetanova Kuca, Mali Ston](https://hr.gaultmillau.com/restaurants/kapetanova-kuca)
22. <a id="source-22"></a>[Bota Sare official menu, Mali Ston](https://www.bota-sare.hr/bota-sare-menu.pdf)
23. <a id="source-23"></a>[Food House Mostar: Best Restaurants in Mostar](https://foodhousemostar.com/best-restaurants-mostar/)
24. <a id="source-24"></a>[Brela Tourist Board gastronomy guide](https://brela.hr/en/gastronomy)
...
50. <a id="source-50"></a>[Britannica: Dubrovnik](https://www.britannica.com/place/Dubrovnik)
51. <a id="source-51"></a>[Britannica: History of Croatia](https://www.britannica.com/place/Croatia/History)
